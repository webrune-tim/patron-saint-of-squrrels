<script lang="ts">
  ...
  // Declared via Svelte 5 state so class:hidden={isScrolling} updates reactively
  ...
  onMount(() => {
    ...
    // Moved inside onMount to guarantee standard closure scope without Svelte interference
...
<div class="container">
  ...
  <section class="scenes" data-props-for="visibility">
  ...
  <footer class="attribution">
    <small>
      Music: <a
        ...
        target="_blank"
        rel="noopener noreferrer">Simplicity by Scott Buckley</a
      ><br />
      License:
      <a
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer">Audio Library</a
      >
    </small>
  </footer>
</div>
